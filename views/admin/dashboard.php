...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-maroon"><i class="ion ion-ios-cart"></i></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">TÀI KHOẢN MỚI</span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        <span class="info-box-icon bg-olive"><i class="ion ion-ios-albums"></i></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          <span class="info-box-text">TỔNG TÀI KHOẢN</span>
  ...
  <div class="row">
    <div class="custom-banner col-sm-12">
      ...
      <img src="views/admin/cover.png" style="width: 100%; filter: brightness(.6);">
    </div>
  </div>
</section>
<!-- jQuery 3 -->
